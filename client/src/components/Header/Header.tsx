  ...
  return (
    <header className='font-[sans-serif] min-h-[60px] tracking-wide relative z-50'>
      <section className="bg-[#004d66] min-h-[40px] px-4 py-2 sm:px-10 flex items-center max-sm:flex-col">
        <button type="button" className="text-white text-sm" onClick={toggleMenu}>
        ...
        <div className="sm:ml-auto text-white">
          <a href="javascript:void(0)" className="text-white text-sm mr-1">Sign In</a>
          /
          <a href="javascript:void(0)" className="text-white text-sm ml-1">Sign Up</a>
        </div>
      </section>
      ...
      <div className='flex flex-wrap items-center justify-between py-3 px-4 sm:px-10 bg-[#151d20] lg:gap-y-4 gap-y-6 gap-x-4'>
        ...
        <div id="collapseMenu"
          className={`max-lg:hidden lg:!flex lg:items-center max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-40 max-lg:before:inset-0 max-lg:before:z-50 ${isMenuOpen ? 'block' : 'hidden'}`}>
          ...
          <ul
            className={`lg:!flex lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-[#151d20] max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50  ${isMenuOpen ? 'block' : 'hidden'}`}>
            ...
            <li
              ...
              <a href='javascript:void(0)' className='text-white block text-[15px] font-medium'>Home</a>
            </li>
            <li
              ...
              <a href='javascript:void(0)' className='text-white block text-[15px] font-medium'>Programs</a>
            </li>
            <li
              className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
              <a href='javascript:void(0)' className='text-white block text-[15px] font-medium'>Mental Health</a>
            </li>
            <li
              className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
              <a href='javascript:void(0)' className='text-white block text-[15px] font-medium'>Substance Abuse</a>
            </li>
            <li
              className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
              <a href='javascript:void(0)' className='text-white block text-[15px] font-medium'>Provider</a>
            </li>
            <li
              className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
              <a href='javascript:void(0)' className='text-white block text-[15px] font-medium'>About</a>
            </li>
          </ul>
        </div>
