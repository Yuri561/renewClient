...
import logoImg from '../../../public/zoom.png';
...
const OnlineZoomSection: React.FC = () => {
  ...
  return (
    <div className="max-w-8xl p-3 bg-slate-700 max-md:max-w-xl mx-auto font-[sans-serif] my-4">
      <InView as="div" onChange={(inView) => controls.start(inView ? 'visible' : 'hidden')}>
        <motion.div
        ...
        <div className="mt-16 grid md:grid-cols-2 items-center gap-16">
          ...
          >
            <img src={logoImg} className="w-full object-contain rounded-md shadow-[0_14px_40px_-11px_rgba(93,96,127,0.2)]" alt="Online Zoom Sessions" />
          </motion.div>
          <motion.div
            initial="hidden"
            animate={controls}
